        ...
        public static function editOrder()
        {
            ...
            Model::update($dafel,(Object)[
                ...
                "fields" => [
                    ...
                    [ "DsObservacaoPedido", "s", @$budget->budget_note ? strtoupper(utf8_decode($budget->budget_note)) : NULL ],
                    [ "DsObservacaoDocumento", "s", @$budget->budget_note_document ? strtoupper(utf8_decode($budget->budget_note_document)) : NULL ],
