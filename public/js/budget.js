        ...
        return(
            '<div class="dropdown dropdown-budget dropdown-actions">' +
                ...
                '<ul class="dropdown-menu pull-right">' +
                    ...
                    '<li><a data-action="audit" disabled="' + ( true || global.login.access.budget.audit.value == 'N' ) + '" data-key="' + budget.key + '" data-id="' + budget.budget.id + '" class="dropdown-item" href="#"><i class="fa fa-shield txt-green"></i>Auditoria</a></li>' +
                    '<li class="divider"></li>' +
